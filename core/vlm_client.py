...
class VLMClient:
    ...
    def analyze_batch(self, frame_batch: List[Dict],
        ...
        prompt_lines = [
            ...
            "Your ONLY task is to read the text visible in the provided frames and output accurate Korean subtitles.",
            "",
            ...
            "5. OCR CORRECTION: The frames may have typos, broken characters, or blur. Infer the correct text from context and fix silently, then translate.",
            "6. EXTRACT ALL TEXT: Extract ALL text you see in the frames regardless of language. Do NOT ignore any text, even if it looks like a sound effect, logo, UI, English, or background sign. Pay special attention to large standalone characters like countdown numbers (e.g., '三', '二', '一') and titles. It is extremely important that you extract every single piece of readable text.",
            "",
